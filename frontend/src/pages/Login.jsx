...
export const Login = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <h2 className="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-gray-100">Cafe Login</h2>
      ...
      <div className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <Link to={PATHS.REGISTER} className="text-indigo-600 hover:underline dark:text-indigo-400">
          Register
        </Link>
      </div>
    </form>
